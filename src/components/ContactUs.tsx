...
class ContactUs extends Component<Props, State, {}> {
  ...
  handleSubmitWithRecaptcha = async (event: any) => {
    ...
    await Promise.all([this.validateEmail(), this.validateNonprofit(), this.validateName(), this.validateDescription()]);
    const {
      email,
      name,
      nonprofit,
    ...
    fetch(`${getServerURL()}/submit-issue`, {
      ...
      .then((responseJSON) => {
        ...
        if (status === 'SUCCESS') {
          alert.show('Thank you for your interest! We will get back to you promptly.');
          this.clearInput();
        } else {
            ...
            <div className="row pb-2 mb-2">
              <div className="col-md-8 mx-auto">
                ...
                <p className="text-grey home-container-text py-3">
                  If you’re interested in learning more or forming a partnership with us, you can email us at contact@keep.id or fill out this contact form.
                </p>
                <form onSubmit={this.handleSubmitWithRecaptcha}>
                  <div className="form-row form-group d-flex align-content-start pb-3">
                    <label htmlFor="name" className="text-left w-100 font-weight-bold pr-3">
                      Your Name
                      <input
                        type="text"
                        className={`w-100 form-control form-purple ${this.colorToggle(nameValidator)}`}
                        id="name"
                  ...
                  <div className="form-row form-group d-flex align-content-start pb-3">
                    <label htmlFor="nonprofit" className="w-100 text-left font-weight-bold pr-3">
                      Name of nonprofit (if applicable)
                      <input
                        type="text"
                        className={`w-100 form-control form-purple ${this.colorToggle(nonprofitValidator)}`}
                        id="nonprofit"
                  ...
                  <div className="form-row form-group d-flex align-content-start pb-3">
                    <label htmlFor="email" className="text-left w-100 font-weight-bold pr-3">
                      Email address
                      <input
                        type="text"
                  ...
                  <div className="form-row form-group d-flex align-content-start">
                    <label htmlFor="description" className="text-left w-100 font-weight-bold pr-3">
                      Send us a note
                      <textarea
                  ...
                  <div className="form-row my-4">
                    <div className="d-flex pt-3 mx-auto">
                      <button type="submit" onClick={this.handleSubmitWithRecaptcha} className={`btn ld-ext-right btn-primary btn-lg ${buttonState}`}>
                        Submit
