...
// change the headings and make them smaller for mobile SARINNA
// MOBILE 2 IN A ROW
// DROP DOWN MAKE SURE THAT EACH CARD IS ONE DROPPIN
// image imports
...
const AboutTeam = () => {
  return (
    <div>
      ...
      <h1 className="hero-header-aboutus text-black pb-3 ">
        Board of Directors
      </h1>
        ...
        <div className="grid">
          <div className="wrapper">
            <ProfileCard
              ...
              info="#jackson"
              id="jackson"
              personDescription="my name is jackson foltz"
            />
            <ProfileCard
        ...
        <div className="grid">
          <div className="wrapper">
            ...
            <ProfileCard
              ...
              id="nick"
              personDescription={
                "I graduated from high school in 2016 and deferred my college acceptance for a year to attend a coding bootcamp in Chicago (Fullstack Academy). After the bootcamp, I started working full time at Catalytic and enjoyed it so much that I cancelled my college plans. I've been there for the last 4 years building an automation platform for businesses. I'm really inspired by the Keep.id mission and have always wanted to work on something with a positive social impact, so I'm super excited to be joining the team!"
              }
            />
            <ProfileCard
              ...
              id="jason"
              personDescription={
                "Hey everyone, my name Is Jason and I'm currently a junior majoring in CS at Boston University. In my free time, I enjoy exercising (weights, and occasionally handball), and all things productivity-related. Looking forward to being able to contribute to the team while honing my own skills."
              }
            />
            ...
            <ProfileCard
              ...
              info="#sarinna"
              id="sarinna"
              personDescription="My name is Sarinna Sung. I am currently studying Computer Science and Statistics at BU. During my free time, I love hiking, biking, and pet sitting."
            />
            <ProfileCard
              imgUrl={ConnorChongImg}
              title="Tirtha Kharel"
        ...
        <div className="grid">
          <div className="wrapper">
            <ProfileCard
              ...
              id="ying"
              personDescription={
                "Hello! I'm Ying, a designer and researcher working with a human-centred and service design lens. I aim to participate in practices making systems more empathetic and caring, and I'm excited to join the team. Let's connect if you like design for social good, strategy games, and dogs!"
              }
            />
            <ProfileCard
              ...
              info="#trang"
              id="trang"
              personDescription="Hope you are doing well! My name is Trang Nguyen and I am currently a self-taught UX Designer. I am very excited to join Team Keep and can’t wait to start working with the team. "
            />
          </div>
        </div>
      </div>
        ...
        <div className="grid">
          <div className="wrapper">
            <ProfileCard
              ...
              info="#cora"
              id="cora"
              personDescription="I’m Cora, a sophomore studying Economics with minors in Finance and Spanish at Princeton University. At Princeton, I’m involved with several groups all aimed to help people in my community, whether it be a student-run nutrition focused start-up, or a firm focused on decarbonizing industries. I’ve worked with both large and small nonprofits in the past and am excited to apply the unique set of skills that I’ve learned to help Keep.id!"
            />
          </div>
        </div>
      </div>
        ...
        <div className="grid">
          <div className="wrapper">
            <ProfileCard
              ...
              info="#samba"
              id="samba"
              personDescription="My name is Samba! I am 23 years old and a recent graduate from Macalester College in Minnesota by way of Frederick, Maryland! Some things I enjoy include listening to music, chatting with friends, and playing trumpet!"
            />
          </div>
        </div>
      </div>
        ...
        <div className="grid">
          <div className="wrapper">
            <ProfileCard
              ...
              id="sean"
              personDescription={
                "My name is Sean Chung and I am a student at Parkland Community College studying to be a Nurse Assistant. I've been volunteering at Keep.id for over half a year now. It has been a great opportunity to grow and learn about the homeless community and the steps that we can take in order to help them. I look forward to continue to work with them and look for ways to challenge myself to develop new skills to help the community."
              }
            />
            <ProfileCard
