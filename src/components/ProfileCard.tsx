...
const ProfileCard = ({
    imgUrl, title, description, info, id, infoadded}) => (
        ...
        <h2 className="profileCard-text">{`${(description)}`} </h2>
            <a className="collapsed" type = "button" data-toggle="collapse" data-bs-target={info} aria-expanded="false" href={info} aria-controls={info} >
